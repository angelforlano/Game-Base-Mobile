...
namespace MysticArsenal
{
    public class MysticButtonScript : MonoBehaviour
    {
        ...
        MysticFireProjectile effectScript;        // A variable used to access the list of projectiles
        MysticProjectileScript projectileScript;
        ...
        void Start()
        {
            effectScript = GameObject.Find("FireProjectile").GetComponent<MysticFireProjectile>(); // The FireProjectile script needs to be on a gameobject called FireProjectile, or else it won't be found
            getProjectileNames();
        ...
        public void getProjectileNames()            // Find and diplay the name of the currently selected projectile
        {
            ...
            projectileScript = effectScript.projectiles[effectScript.currentProjectile].GetComponent<MysticProjectileScript>();// Access the currently selected projectile's 'ProjectileScript'
